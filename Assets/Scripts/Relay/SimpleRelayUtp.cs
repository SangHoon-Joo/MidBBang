    ...
    public async void OnJoin()
    {
        ...
        try
        {
            ...
            NetworkManager.Singleton.GetComponent<UnityTransport>().SetClientRelayData(
                playerAllocation.RelayServer.IpV4,
                (ushort)playerAllocation.RelayServer.Port,
                playerAllocation.AllocationIdBytes,
                playerAllocation.Key,
                playerAllocation.ConnectionData,
                playerAllocation.HostConnectionData
            );
