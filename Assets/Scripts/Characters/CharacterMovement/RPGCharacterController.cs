...
namespace ProjectWilson
{
    ...
    public class RPGCharacterController : MonoBehaviour
    {
        ...
        public event System.Action<float, int> OnAttack;
        /// <summary>
        ...
        public void SetMoveInput(Vector3 moveInput)
        {
            ...
            var relativeVelocity = moveInput.x * right + moveInput.y * forward;
        ...
        public void Attack(int attackNumber, Side attackSide, Weapon leftWeapon, Weapon rightWeapon, float range, int amount, float duration)
        {
