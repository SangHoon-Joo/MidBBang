...
namespace ProjectWilson.Actions
{
    ...
    public abstract class BaseActionHandler<TContext> : IActionHandler
    {
        ...
        /// </summary>
        public virtual void AddStartListener(System.Action callback)
        { OnStart += callback; }

        /// <summary>
        /// Remove an event listener from OnStart. See IActionHandler#RemoveStartListener.
        /// </summary>
        public virtual void RemoveStartListener(System.Action callback)
        { OnStart -= callback; }
        ...
        /// </summary>
        public virtual void AddEndListener(System.Action callback)
        { OnEnd += callback; }

        /// <summary>
        /// Remove an event listener from OnEnd. See IActionHandler#RemoveEndListener.
        /// </summary>
        public virtual void RemoveEndListener(System.Action callback)
        { OnEnd -= callback; }
