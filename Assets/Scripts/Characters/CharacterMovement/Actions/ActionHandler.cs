...
namespace ProjectWilson.Actions
{
    ...
    public interface IActionHandler
    {
        ...
        void AddStartListener(System.Action callback);

        /// <summary>
        /// Remove an event listener from the start callbacks.
        /// </summary>
        /// <param name="callback"></param>
        void RemoveStartListener(System.Action callback);
        ...
        /// </summary>
        /// <param name="callback">Event listener.</param>
        void AddEndListener(System.Action callback);

        /// <summary>
        /// Remove an event listener from the end callbacks.
        /// </summary>
        /// <param name="callback"></param>
        void RemoveEndListener(System.Action callback);
    }
}