using System;
using ProjectWilson.GamePlay.Character;
using ProjectWilson.Infrastructure;
using UnityEngine;
using Action = ProjectWilson.GamePlay.Actions.Action;

namespace ProjectWilson.GamePlay.Configuration
{
    /// <summary>
